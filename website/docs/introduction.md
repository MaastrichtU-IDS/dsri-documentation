...
- [Research Data Compliance Self Assessment](https://maastrichtu-library.github.io/rdm-compliance-decision-tool/) — check whether your data meets the requirements for processing on the DSRI
